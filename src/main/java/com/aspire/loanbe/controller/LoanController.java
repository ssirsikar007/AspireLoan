...
public class LoanController {
	...
	public ResponseEntity<?> repay(@RequestBody RepaymentRequest repaymentRequest, @PathVariable Long id) {
		try {
			iloanService.repay(repaymentRequest.getLoanId(), repaymentRequest.getAmount(), id);
			return ResponseEntity.ok(SuccessMessageConstants.SCHEDULED_PAYMENT_SUCCESSFULL);
